...
* If packaging needs adjustment, prefer metadata changes, build wiring, or lightweight mirroring/symlinking.
* Do not "simplify" the project by making `galitime_pkg/` canonical unless explicitly requested.
...
* Keep test output stable and readable, with numbered step messages such as `[1/3] ...`.
